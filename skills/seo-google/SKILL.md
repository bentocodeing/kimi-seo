...
```bash
kimi-seo run google_auth.py --check --json
```
...
**Script:** `kimi-seo run pagespeed_check.py <url> --json`
...
**Script:** `kimi-seo run crux_history.py <url> --json`
**Reference:** `references/pagespeed-crux-api.md`
...
**Script:** `kimi-seo run gsc_query.py --property <property> --json`
...
**Script:** `kimi-seo run gsc_inspect.py <url> --json`
...
**Script:** `kimi-seo run gsc_query.py sitemaps --property <property> --json`
...
**Script:** `kimi-seo run indexing_notify.py <url> --json`
...
**Script:** `kimi-seo run indexing_notify.py --batch <file> --json`
...
**Script:** `kimi-seo run ga4_report.py --property <id> --json`
...
**Script:** `kimi-seo run ga4_report.py --property <id> --report top-pages --json`
...
**Script:** `kimi-seo run youtube_search.py search "<query>" --json`
...
**Script:** `kimi-seo run youtube_search.py video <video_id> --json`
...
**Script:** `kimi-seo run nlp_analyze.py --url <url> --json` or `--text "..."`
...
**Script:** `kimi-seo run nlp_analyze.py --url <url> --features entities --json`
...
**Script:** `kimi-seo run keyword_planner.py ideas "<seed>" --json`
...
**Script:** `kimi-seo run keyword_planner.py volume "<kw1>,<kw2>" --json`
...
**Script:** `kimi-seo run google_report.py --type <type> --data <json> --domain <domain> --format pdf`
