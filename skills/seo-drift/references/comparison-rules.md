...
- **Cross-ref**: `/kimi-seo:seo schema <url>`
...
- **Cross-ref**: `/kimi-seo:seo technical <url>`
...
- **Cross-ref**: `/kimi-seo:seo content <url>`
...
- **Cross-ref**: `/kimi-seo:seo page <url>`
...
- **Cross-ref**: `/kimi-seo:seo google psi <url>`
...
- **Action**: Positive change. Validate the new schema with `/kimi-seo:seo schema <url>`.
- **Cross-ref**: `/kimi-seo:seo schema <url>`
