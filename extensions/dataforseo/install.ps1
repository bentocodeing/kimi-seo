...
Write-Host "     /kimi-seo:seo dataforseo serp best coffee shops"
Write-Host "     /kimi-seo:seo dataforseo keywords seo tools"
Write-Host "     /kimi-seo:seo dataforseo backlinks example.com"
Write-Host "     /kimi-seo:seo dataforseo ai-mentions your brand"
Write-Host ""
