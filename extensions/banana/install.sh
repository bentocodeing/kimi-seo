...
PY
    ...
    echo "  2. Run commands:"
    echo "     /kimi-seo:seo image-gen og \"Professional SaaS dashboard\""
    echo "     /kimi-seo:seo image-gen hero \"Dramatic sunset over city skyline\""
    echo "     /kimi-seo:seo image-gen product \"Wireless headphones on marble\""
    echo "     /kimi-seo:seo image-gen infographic \"SEO ranking factors 2026\""
    echo "     /kimi-seo:seo image-gen custom \"Any creative concept\""
    echo "     /kimi-seo:seo image-gen batch \"Product variations\" 3"
    echo ""
