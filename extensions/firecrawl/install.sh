...
PY
    ...
    echo "  2. Run commands:"
    echo "     /kimi-seo:seo firecrawl crawl https://example.com"
    echo "     /kimi-seo:seo firecrawl map https://example.com"
    echo "     /kimi-seo:seo firecrawl scrape https://example.com/page"
    echo "     /kimi-seo:seo firecrawl search \"query\" https://example.com"
    echo ""
