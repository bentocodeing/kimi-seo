...
Write-Host ""
Write-Host "Usage:"
Write-Host "  /kimi-seo:seo firecrawl crawl https://example.com"
Write-Host "  /kimi-seo:seo firecrawl map https://example.com"
Write-Host "  /kimi-seo:seo firecrawl scrape https://example.com/page"
