#!/usr/bin/env python3
"""
Moz Link Explorer API client for Kimi SEO.
...
RATE_LIMIT_DELAY = 10
RATE_LIMIT_FILE = os.path.expanduser("~/.cache/kimi-seo/moz_last_request.lock")
...
def main():
    parser = argparse.ArgumentParser(
        description="Moz Link Explorer API client for Kimi SEO"
    )
    parser.add_argument(
        "command",
