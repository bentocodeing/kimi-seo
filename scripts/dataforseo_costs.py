...
Config: ~/.config/kimi-seo/dataforseo-costs.json
Ledger: ~/.config/kimi-seo/dataforseo-ledger.json
...
Security fixes: config path corrected to ~/.config/kimi-seo/
"""
...
# ----- paths -----
CONFIG_DIR = Path.home() / ".config" / "kimi-seo"
