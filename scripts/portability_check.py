...
kimi-seo skills run under Claude Code, but also Cursor / Cursor Cloud
        ...
        if 'version' not in frontmatter["metadata"]:
            findings.append({
                ...
                "message": "metadata block present but no version field; "
                           "kimi-seo's manifest test expects "
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Cross-platform portability lint for kimi-seo SKILL.md files."
    )
