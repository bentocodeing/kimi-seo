...
- Fetch the target URL using `kimi-seo run render_page.py "<url>" --mode auto --json` (SPA-aware SSRF-protected renderer)
- Parse with `kimi-seo run parse_html.py --url "<url>"` to extract SEO elements
