<div class="space-y-5">
    ...
    <div class="grid gap-5 sm:grid-cols-2">
        <div>
            <label for="image" class="label">Image upload <span class="muted">(max 2 MB)</span></label>
    ...
    <div class="grid gap-5 sm:grid-cols-2">
        <div>
            ...
            <input type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $ad->sort_order ?? 0) }}" min="0" class="input">
        </div>
        <div class="flex items-end pb-2">
            <label class="inline-flex items-center gap-2 text-sm muted-strong">
